angular.module('app', ['ngStorage']).controller('IndexController', function ($scope, $http, $localStorage){
    ...
    $scope.setMinAndMax= function (minCost, maxCost){
   ...
   $scope.isLoggedIn = function (){
    ...
    $scope.loadProducts = function (){
        $http({method:'GET', url:'http://localhost:5555/core/api/v1/products', params: {'minCost':$scope.minCost, 'maxCost': $scope.maxCost}}).then(function (response){
